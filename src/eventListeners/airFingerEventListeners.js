...
const logger = getLogger('eventListeners:airFingerEventListeners');
...
function airTouchDown(e) {
  ...
  function onMouseUp(e) {
    ...
    document.removeEventListener('AirTouchDragFingerEnd', onMouseUp);
  ...
  document.addEventListener('AirTouchDragFingerEnd', onMouseUp);
  addedListeners.set(onMouseMove, 'AirTouchMove');
  addedListeners.set(onMouseUp, 'AirTouchDragFingerEnd');
}
...
function disable(element) {
  element.removeEventListener('AirTouchMove', airTouchMove);
  element.removeEventListener('AirTouchDragFingerStart', airTouchDown);
...
function enable(element) {
  ...
  element.addEventListener('AirTouchMove', airTouchMove);
  element.addEventListener('AirTouchDragFingerStart', airTouchDown);
}
