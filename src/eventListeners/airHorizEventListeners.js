...
const logger = getLogger('eventListeners:airHorizEventListeners');
...
function airTouchDown(e) {
  ...
  function onMouseUp(e) {
    ...
    document.removeEventListener('AirTouchDragFlatHorizEnd', onMouseUp);
  ...
  document.addEventListener('AirTouchDragFlatHorizEnd', onMouseUp);
  addedListeners.set(onMouseMove, 'AirTouchMove');
  addedListeners.set(onMouseUp, 'AirTouchDragFlatHorizEnd');
}
...
function disable(element) {
  element.removeEventListener('AirTouchMove', airTouchMove);
  element.removeEventListener('AirTouchDragFlatHorizStart', airTouchDown);
...
function enable(element) {
  ...
  element.addEventListener('AirTouchMove', airTouchMove);
  element.addEventListener('AirTouchDragFlatHorizStart', airTouchDown);
}
